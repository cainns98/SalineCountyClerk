            ...
            <div class="col-md-9">
                <div class="container-fluid">
                    ...
                    <div class="list-group">
                      ...
                      <a href="https://caseinfo.aoc.arkansas.gov/cconnect/PROD/public/ck_public_qry_main.cp_main_idx" target="_blank" class="list-group-item">
                          AOC CourtConnect Website
                      </a>
                      <a href="https://courts.arkansas.gov/administration/acap/courtconnect" target="_blank" class="list-group-item">
                          Arkansas Judiciary CourtConnect – Overview
                      </a>
                      <a href="https://courts.arkansas.gov/administration/acap/courtconnect/help" target="_blank" class="list-group-item">
                          Arkansas Judiciary CourtConnect – Help Overview
                      </a>
                      <a href="https://caseinfo.aoc.arkansas.gov/docs/helppublic.htm" target="_blank" class="list-group-item">
                          Arkansas Judiciary CourtConnect – Help
                      </a>
                    </div>
                </div>
            </div>
